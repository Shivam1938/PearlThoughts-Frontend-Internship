...
export default function AuthShell({ children }: AuthShellProps) {
  return (
    <main className="h-screen overflow-hidden bg-[var(--canvas)] px-4 py-4 sm:px-8 sm:py-8">
      <div className="mx-auto grid h-full min-h-0 max-w-6xl overflow-hidden rounded-2xl border border-[var(--line)] bg-white shadow-[0_24px_70px_rgba(27,41,37,0.12)] lg:grid-cols-[0.9fr_1.1fr]">
        <section className="relative overflow-hidden bg-[var(--brand)] px-6 py-8 text-white sm:px-10 sm:py-10 lg:flex lg:flex-col lg:justify-between lg:px-12 lg:py-12" aria-labelledby="brand-title">
          ...
          <div className="relative">
            <div className="grid size-12 place-items-center rounded-xl bg-white font-serif text-2xl font-semibold text-[var(--brand)] shadow-lg">S</div>
          ...
          <p className="relative mt-10 text-sm text-emerald-100">Schedula for modern care teams</p>
        </section>
        <section className="min-h-0 overflow-y-auto bg-white px-5 py-8 sm:px-10 sm:py-10 lg:px-14" aria-label="Account access">
