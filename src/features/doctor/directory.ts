...
export function saveDirectoryDoctor(doctor: DoctorUser): void {
  const directoryDoctor: Doctor = { id: doctor.id, name: doctor.name, specialty: doctor.specialization, city: doctor.clinicAddress.split(",").pop()?.trim() || "Your clinic", photo: doctor.profileImage || "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&w=500&q=80", age: 0, rating: 0, fee: 500, experience: doctor.experienceYears, patientSatisfaction: 0, reviewCount: 0 };
